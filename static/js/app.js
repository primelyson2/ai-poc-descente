...
(function () {
  const ROUTES = {
    ...
    chat_tl:   { render: () => window.Views.aiChatTl(),       label: "Select AI Test - AI Chat for Table list" },
    chat:      { render: () => window.Views.aiChat(),         label: "Select AI Test - AI Chat" },
    chat2:     { render: () => window.Views.aiChatV2(),       label: "Select AI Test - AI Chat2" },
    ...
    history2:  { render: () => window.Views.history2(),       label: "Select AI Test - History2" },
    agent_history: { render: () => window.Views.agentHistory(), label: "Select AI Test - Agent History" },
  ...
  const MANAGED_MENUS = [
    ...
    { route: "chat_tl",    label: "Select AI Test - AI Chat for Table list" },
    { route: "chat",       label: "Select AI Test - AI Chat" },
    { route: "chat2",      label: "Select AI Test - AI Chat2" },
    { route: "history",    label: "Select AI Test - History" },
    { route: "history2",   label: "Select AI Test - History2" },
    { route: "agent_history", label: "Select AI Test - Agent History" },
