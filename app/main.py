...
from app.routers import agents, asta_proxy, auth as auth_router, chat, chat2, chat_tl, databases, history, history2, nl2sql, objects, persona_analysis, personas, predefined, profiles, vpd
...
app.include_router(chat2.router, prefix="/api")
app.include_router(chat_tl.router, prefix="/api")
